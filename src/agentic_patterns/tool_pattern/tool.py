...
def get_fn_signature(fn: Callable) -> dict:
    ...
    # This line helps in creating the schema of the type annotations on the function where k holds the keys and v holds values
    # We have skipped the return annotations as we only want to extract input params
    schema = {
...
def validate_arguments(tool_call: dict, tool_signature: dict) -> dict:
    ...
    # This is overly simplified but enough for simple Tools.
    type_mapping = {
        "int": int,
        "str": str,
        "bool": bool,
